...
@Component({
  selector: 'app-page-shop-grid',
  templateUrl: './page-shop-grid.component.html',
  styleUrls: ['./page-shop-grid.component.css']
})
export class PageShopGridComponent implements OnInit {
