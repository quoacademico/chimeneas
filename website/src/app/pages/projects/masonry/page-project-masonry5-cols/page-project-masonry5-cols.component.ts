...
@Component({
  selector: 'app-page-project-masonry5-cols',
  templateUrl: './page-project-masonry5-cols.component.html',
  styleUrls: ['./page-project-masonry5-cols.component.css']
})
export class PageProjectMasonry5ColsComponent implements OnInit {
