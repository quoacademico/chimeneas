...
@Component({
  selector: 'app-page-project-masonry4-cols',
  templateUrl: './page-project-masonry4-cols.component.html',
  styleUrls: ['./page-project-masonry4-cols.component.css']
})
export class PageProjectMasonry4ColsComponent implements OnInit {
