...
@Component({
  selector: 'app-page-project-masonry5-cols-nogut',
  templateUrl: './page-project-masonry5-cols-nogut.component.html',
  styleUrls: ['./page-project-masonry5-cols-nogut.component.css']
})
export class PageProjectMasonry5ColsNogutComponent implements OnInit {
