...
@Component({
  selector: 'app-page-project-grid5-cols-nogut',
  templateUrl: './page-project-grid5-cols-nogut.component.html',
  styleUrls: ['./page-project-grid5-cols-nogut.component.css']
})
export class PageProjectGrid5ColsNogutComponent implements OnInit {
