...
@Component({
  selector: 'app-page-project-grid4-cols',
  templateUrl: './page-project-grid4-cols.component.html',
  styleUrls: ['./page-project-grid4-cols.component.css']
})
export class PageProjectGrid4ColsComponent implements OnInit {
