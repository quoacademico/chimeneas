...
@Component({
  selector: 'app-page-project-grid3-cols-nogut',
  templateUrl: './page-project-grid3-cols-nogut.component.html',
  styleUrls: ['./page-project-grid3-cols-nogut.component.css']
})
export class PageProjectGrid3ColsNogutComponent implements OnInit {
